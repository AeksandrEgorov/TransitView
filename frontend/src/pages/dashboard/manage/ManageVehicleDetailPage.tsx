// This page shows one vehicle for editors/admins with full moderation context.
// It includes related photos, review actions, edit/delete flows, and preview modals.
...
import {
  ConditionInfoCard,
  InfoCard,
  type ManageVehiclePhoto,
  VehiclePhotoCard,
} from "../../../components/dashboard/manage-vehicle-detail/VehicleDetailCards";
